...
public class KafkaService {
  ...
  private static synchronized void configureTopicRetention( AdminClient adminClient , String topicName ,
                                                            Duration retentionTime ) {
    ConfigResource resource = new ConfigResource( ConfigResource.Type.TOPIC , topicName );
    ConfigEntry retentionConfig = new ConfigEntry( TopicConfig.RETENTION_MS_CONFIG ,
        Long.toString( retentionTime.toMillis( ) ) );
